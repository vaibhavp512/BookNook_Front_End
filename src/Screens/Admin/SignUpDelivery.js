...
const SignUpDelivery = () => {
    ...
    const registerUser = () => {
        if (email.length === 0) {
            ...
            axios.post(url + '/customer/register', { ufirstName: firstName, ulastName: lastName, ugender: gender, uemail: email, ucontactNo: contactNo, upassword: password, urole: "delivery" })
                .then((response) => {
                ...
                <div className="card-body p-4 p-md-5">
                    ...
                    <form>
                        ...
                        <Link to="/dashadmin" style={{ textDecoration: 'none' }}>
                            <a className="btn btn-primary btn-lg btn-css" style={{width: 150}}>Back</a>
                        </Link>
                        </div>
                        </div>
                    </form>
